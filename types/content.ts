...
export type Location = { slug:string; name:string; description:string; mapPosition:{x:number;y:number}; visited:boolean; date?:string; events:string[]; items:string[]; characters:string[]; image:string };
